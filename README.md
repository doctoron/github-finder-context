...
Practicing application development without any third party state manager (i.e. Redux).  
React Hooks was employed including the Context API with useReducer, useContext, useState and useEffect.
